defmodule Sneakers23.Inventory.InventoryTest do
  ...
  describe "add_availability/2" do
    test "availabilities can be added" do
      ...
      |> assert_inventory(:availabilities, %{1 => availability})
      |> Inventory.add_availabilities([availability2])
      |> assert_inventory(:availabilities, %{1 => availability, 2 => availability2})
    end
  end
end
