defmodule Mastery.Boundary.Validator do
  ...
  defp check_required_field(true = _present, fields, errors, field_name, func) do
    valid = fields |> Map.fetch!(field_name) |> func.()
    check_field(valid, errors, field_name)
  end

  defp check_required_field(_present, _fields, errors, field_name, _func) do
